"""Export reconstructed flow NetCDF from MLP checkpoint only."""
...
def main() -> None:
    ...
    p.add_argument("--ckpt", default="pinn_sr_mlp_uv_best.pt")
    p.add_argument("--cmems", default=r"D:\data\uswc_2023_cmems_cleaned.nc")
    p.add_argument("--out", default=r"D:\data\recon_mlp.nc")
